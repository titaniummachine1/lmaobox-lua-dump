...
local function OnCreateMove()
    ...
    CalcStrafe(me)
    local strafeAngle = 0 --strafeAngles[pLocal:GetIndex()] or 0
    local predData = Prediction.Player(WpLocal, 50, strafeAngle) -- Time (ticks), strafe angle (0 or nil = disabled)
