...
local function checkPathClearance(dest, direction, angle, distance, origin, target)
    ...
    local shouldhitentity = function(entity) return entity:GetIndex() ~= target:GetIndex() or entity:GetIndex() ~= entities.GetLocalPlayer():GetIndex() end
...
local function FindBestShootingPosition(origin, dest, target, BlastRadius)
    ...
    local function checkPath(direction, angle, distance)
        ...
        local traceLineOriginToPoint = engine.TraceLine(origin, point, MASK_SOLID_BRUSHONLY, function(entity) return entity:GetIndex() ~= target:GetIndex() end)
    ...
    local initialTrace = engine.TraceLine(origin, dest, MASK_SOLID_BRUSHONLY, function(entity) return entity:GetIndex() ~= target:GetIndex() end)
