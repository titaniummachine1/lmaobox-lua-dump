...
if attacker ~= entities.GetLocalPlayer() then return end
...
local function OnCreateMove()
    ...
    TIME_TO_DEATH = (victim:GetInt("health") - DPS)
end
        ...
        if p:IsAlive() and not p:IsDormant() and pLocal:GetTeamNumber() ~= p:GetTeamNumber() then
            ...
            if screenPos ~= nil then
                ...
                if enemyScreenPos ~= nil then
                    ...
                    local text2 = tostring(TIME_TO_DEATH) .. " TTD"
                    ...
                    -- Fill the health bar with a color based on how much health the player has remaining
                        ...
                        input_offsetX = 0
                        -- Draw the text inside the box
                            draw.Text(math.floor(textX - input_offsetX - 10), math.floor(textY - input_offsetY), text3)
